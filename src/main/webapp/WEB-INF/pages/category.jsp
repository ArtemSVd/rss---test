...
<div class="container mt-5">
    ...
    <c:if test="${!anon}">
        <%@include file="../templates/addCategoryForm.jsp" %>
    </c:if>

<form:form action="/category" method="post" modelAttribute="selector" name="categoriesForm">
            ...
            <c:forEach var="category" items="${categories}">
                ...
                <div class="col-1 align-self-center item pt-3">
                    ...
                    <script> function x(){
                            ...
                            if(${selector.selectedCategories.contains(category.id)}) {
                                c.checked = true;
                            };
                    }
                        x();
